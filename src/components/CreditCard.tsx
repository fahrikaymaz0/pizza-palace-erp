...
export default function CreditCard({ cardNumber, cardHolder, expiryDate, cvv, focused }: CreditCardProps) {
  ...
  const detectCard = (cardNumber: string) => {
    ...
    if (cleanNumber.startsWith('4')) {
      return { bank: "VISA Kart", type: "VISA", subType: "CLASSIC", class: "default", code: "VISA" };
    }
    if (cleanNumber.startsWith('5')) {
      return { bank: "Mastercard", type: "MASTERCARD", subType: "CLASSIC", class: "default", code: "MC" };
    }
    if (cleanNumber.startsWith('9792')) {
      return { bank: "Troy Kart", type: "TROY", subType: "CLASSIC", class: "default", code: "TROY" };
    }
  ...
  return (
    <div className="perspective-1000 w-full max-w-md">
      ...
      >
        {/* Front of Card */}
        <div className={`absolute inset-0 w-full h-full rounded-2xl shadow-2xl backface-hidden ${getCardClass()} text-white p-6 flex flex-col justify-between overflow-hidden`}>
          {/* Shine Effect */}
          ...
          <div className="flex justify-between items-start relative z-10">
            ...
            <div className="text-right text-xs opacity-90">
              ...
              {detectedCard?.class === 'paytr-test' && (
                <div className="text-xs text-yellow-300 font-bold">TEST KARTI</div>
              )}
            </div>
          </div>
          ...
          <div className="flex justify-between items-end relative z-10">
            <div className="flex-1">
              <div className="text-xs opacity-80 mb-1 uppercase tracking-wide font-medium">Kart Sahibi</div>
              <div className="text-sm font-semibold tracking-wide">{getDisplayHolder()}</div>
            </div>
            <div className="text-center mx-4">
              <div className="text-xs opacity-80 mb-1 uppercase tracking-wide font-medium">Son Kullanım</div>
              <div className="text-sm font-semibold">{getDisplayExpiry()}</div>
            </div>
            <div className="text-right">
              <div className="text-xs opacity-80 mb-1 uppercase tracking-wide font-medium">Ağ</div>
        ...
        {/* Back of Card */}
        <div className={`absolute inset-0 w-full h-full rounded-2xl shadow-2xl backface-hidden rotate-y-180 ${getCardClass()} text-white overflow-hidden`}>
          {/* Magnetic Strip */}
          ...
          <div className="p-6 pt-4">
            ...
            <div className="bg-white/95 backdrop-blur-sm text-black p-4 rounded-lg mb-4 shadow-lg">
              <div className="text-xs mb-2 uppercase tracking-wide font-semibold text-gray-600">CVV / CVC</div>
            ...
            <div className="space-y-2">
              ...
              <div className="text-xs opacity-70 leading-relaxed">
                Bu kartı sadece yetkili kişi kullanabilir. PayTR Direkt API ile güvenli ödeme.
              </div>
