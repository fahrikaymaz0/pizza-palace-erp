...
export default function ProfilePage() {
  ...
  const loadUserProfile = async () => {
    try {
      ...
      if (!authResponse.ok) {
        console.log(
          '⚠️ Auth kontrolü başarısız (401 normal olabilir), profile API deneniyor...'
        );
  ...
  const verifyEmail = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setSuccess(
          'Email başarıyla doğrulandı! Artık siparişleriniz email adresinize gönderilecek'
        );
                        ...
                        <div className="flex items-start space-x-4">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-yellow-700 mb-4">
                              Email adresinizi doğrulamadığınız için sipariş
                              detayları email adresinize gönderilmeyecek.
                              Doğrulama yaparak sipariş takibi ve özel
                              tekliflerden haberdar olun.
                            </p>
