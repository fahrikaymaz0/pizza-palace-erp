      ...
      testCards: [
        {
          ...
          brand: 'VISA',
          description: 'PayTR VISA Test Kartı',
        },
        {
          number: '5406675406675403',
          brand: 'MasterCard',
          description: 'PayTR MasterCard Test Kartı',
        },
        {
          number: '9792030394440796',
          brand: 'Troy',
          description: 'PayTR Troy Test Kartı',
        },
      ],
      route: '/paytr-test',
          ...
          <div className="space-y-8">
            <div className="text-center">
              <h2 className="text-3xl font-bold text-white mb-4">
                PayTR Entegrasyon Sistemi
              </h2>
              <p className="text-gray-300 text-lg max-w-3xl mx-auto">
                PayTR&apos;nin tüm API modüllerini kapsayan kapsamlı entegrasyon
                sistemi. Test kartları ile dinamik ödeme işlemleri, güvenli
                callback yönetimi ve gerçek zamanlı durum sorgulama özellikleri.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {modules.map(module => (
                ...
                >
                  <div
                    className={`w-12 h-12 bg-gradient-to-br ${module.color} rounded-lg flex items-center justify-center mb-4`}
                  >
            ...
            {modules.map((module, index) => (
              ...
              >
                <div className="flex items-start justify-between mb-6">
                  ...
                  <div
                    className={`w-16 h-16 bg-gradient-to-br ${module.color} rounded-xl flex items-center justify-center`}
                  >
        ...
        {activeTab === 'test-cards' && (
          <div className="space-y-8">
            <div className="text-center">
              ...
              <p className="text-gray-300 text-lg">
                PayTR Direkt API için resmi test kartları. Bu kartları
                girdiğinizde otomatik olarak algılanacak ve test modunda
                işlenecektir.
              </p>
            </div>
                ...
                >
                  ...
                  <div className="mt-4 p-3 bg-orange-500/20 rounded-lg border border-orange-500/30">
                    <p className="text-orange-200 text-xs">
                      💡 Bu kart numarasını girdiğinizde otomatik olarak
                      algılanacak ve test kartı olarak işaretlenecektir.
                    </p>
                  </div>
                </div>
              ))}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-black/30 rounded-lg p-4">
                    <div className="text-green-400 font-mono text-sm">
                      POST /api/paytr/link-api
                    </div>
                    <div className="text-gray-400 text-xs mt-1">
                      PayTR Link API ödeme linki oluşturma
                    </div>
                  </div>
                  <div className="bg-black/30 rounded-lg p-4">
                    <div className="text-green-400 font-mono text-sm">
                      POST /api/paytr/status-inquiry
                    </div>
                    <div className="text-gray-400 text-xs mt-1">
                      PayTR Status Inquiry API durum sorgulama
                    </div>
                  </div>
                  <div className="bg-black/30 rounded-lg p-4">
                    <div className="text-green-400 font-mono text-sm">
              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-black/30 rounded-lg p-4">
                    ...
                    <div className="text-gray-400 text-xs mt-1">
                      PayTR Status Inquiry test sayfası
                    </div>
                  </div>
                  <div className="bg-black/30 rounded-lg p-4">
                    <div className="text-blue-400 font-mono text-sm">
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <div className="text-gray-400 text-sm mt-1">
                      Kredi kartı bilgilerini doğrudan işleme
                    </div>
                  </a>
                  <a
              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-black/30 rounded-lg p-4">
                    ...
                    <div className="text-gray-400 text-sm mt-1">
                      Environment variables ayarlanmamışsa otomatik simülasyon
                      modu aktif olur
                    </div>
                  </div>
                  <div className="bg-black/30 rounded-lg p-4">
                    ...
                    <div className="text-gray-400 text-sm mt-1">
                      Tüm API istekleri hash doğrulama ile güvenli şekilde
                      işlenir
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-gradient-to-r from-blue-500/20 to-purple-500/20 backdrop-blur-lg rounded-2xl p-8 border border-blue-500/30">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center">
                  ...
                  <p className="text-gray-300 text-sm">
                    PayTR test kartlarından birini kredi kartı formuna girin
                  </p>
                </div>
                <div className="text-center">
                  <div className="w-12 h-12 bg-orange-500 rounded-full flex items-center justify-center mx-auto mb-3">
                  ...
                  <p className="text-gray-300 text-sm">
                    Kart otomatik olarak algılanacak ve test modunda
                    işaretlenecek
                  </p>
                </div>
                <div className="text-center">
                  ...
                  <p className="text-gray-300 text-sm">
                    Test kartı ile simüle edilmiş ödeme işlemi gerçekleştirilir
                  </p>
                </div>
              </div>
            </div>
